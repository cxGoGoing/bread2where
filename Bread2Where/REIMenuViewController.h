...
@protocol REIMenuViewControllerDelegate <NSObject>

-(void)menuViewController:(id)vc currentPageChanged:(NSInteger)pageIndex;

@end

@interface REIMenuViewController : UIViewController
@property(nonatomic,assign) id<REIMenuViewControllerDelegate>delegate;
